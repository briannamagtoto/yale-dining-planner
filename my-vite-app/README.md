...
### Task 1
This section should describe the first task that the team focused on implementing

### Task 2 
This section should describe the second task that the team focused on implementing
...
Add link here, e.g., https://github.com/Yale-CPSC484-HCI/example-react-project/
